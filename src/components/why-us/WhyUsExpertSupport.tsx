        ...
        <div className="flex flex-col-reverse lg:flex-row gap-12 items-center">
          ...
          <div className="w-full lg:w-1/2">
            <div className="relative">
              {/* Decorative elements */}
              <div className="absolute -top-4 -left-4 w-24 h-24 bg-blue-500/20 rounded-full blur-xl pointer-events-none"></div>
              <div className="absolute -bottom-4 -right-4 w-32 h-32 bg-teal-400/20 rounded-full blur-xl pointer-events-none"></div>
          ...
          <div className="w-full lg:w-1/2 space-y-10">
            <div>
              <h2 className="text-3xl font-bold text-white mb-4">STAY UP TO DATE WITH OUR EXPERTS!</h2>
            ...
            <div>
              <h2 className="text-3xl font-bold text-white mb-4">Experience More Than Trading</h2>
              <p className="text-gray-300 text-lg leading-relaxed">
            ...
            <div className="pt-2">
              <Link href="/register" className="inline-flex items-center px-8 py-4 border border-transparent text-lg font-medium rounded-lg shadow-lg text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-all duration-200">
                Start Trading Now
