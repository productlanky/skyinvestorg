  ...
  return (
    <section className="py-16 bg-gray-900 relative overflow-hidden">
      ...
      <div className="absolute inset-0 z-0 bg-gray-900">
        <div className="absolute inset-0 bg-gradient-to-r from-blue-900/20 to-teal-900/20 mix-blend-overlay"></div>
      </div>
